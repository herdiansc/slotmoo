    <div class="notes-index-container">
        <div class="index-header"><h1>TERM OF SERVICE</h1></div>
<div style="padding: 40px;font-size: 10pt;line-height: 20px;text-align: left;">
This Privacy Policy governs the manner in which <?php echo $this->Html->link(SITE_NAME,'/') ?> collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="<?php echo Router::url('/',true) ?>"><?php echo SITE_NAME ?></a> website ("Site"). This privacy policy applies to the Site and all products and services offered by <?php echo $this->Html->link(SITE_NAME,'/') ?>.<br><br>

<strong>Personal identification information</strong><br><br>
...
<strong>Non-personal identification information</strong><br><br>
...
<strong>Web browser cookies</strong><br><br>
...
<strong>How we use collected information</strong><br><br>

<?php echo $this->Html->link(SITE_NAME,'/') ?> may collect and use Users personal information for the following purposes:<br>
<ul>
...
<strong>Sharing your personal information</strong><br><br>
...
<strong>Compliance with children's online privacy protection act</strong><br><br>
...
<?php echo $this->Html->link(SITE_NAME,'/') ?> has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br><br>

<strong>Your acceptance of these terms</strong><br><br>
...
<a href="<?php echo Router::url('/',true) ?>"><?php echo SITE_NAME ?></a><br>
<br>

<div style="font-size:10px;color:gray;">This document was last updated on September 10, 2012</div>
</div>
