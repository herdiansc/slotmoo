...
<div class="users index">
	...
	foreach ($users as $user):
		...
		?>
		<tr<?php echo $class; ?>>
			<td><?php echo $this->Html->link($user[$model]['username'], array('admin'=>false,'plugin'=>'users','controller'=>'users','action' => 'view', $user[$model]['slug'])); ?></td>
			<td><?php echo $this->Time->timeAgoInWords($user[$model]['created']); ?></td>
			<!--<td class="actions">
