...
//console.log(options);
        ...
        if ($('#css-hovercard').length <= 0) {
            var hovercardTempCSS = '<style id="css-hovercard" type="text/css">' +
                                    ...
                                    '.hc-name { position:relative; display:inline-block; }' +
                                    //'.hc-details { left:20px; margin-right:80px; text-align:left; font-family:Sans-serif !important; font-size:12px !important; color:#666 !important; line-height:1.5em; border:solid 1px #eee; position:absolute;top:12px;z-index:100;padding:5px;-moz-box-shadow:5px 5px 0px #333;-webkit-box-shadow:5px 5px 0px #333;box-shadow:5px 5px 0px #333;display:none;}' +
                                    '.hc-details { left:20px; margin-right:80px; text-align:left; font-family:Sans-serif !important; font-size:12px !important; color:#666 !important; line-height:1.5em; border:solid 1px #eee; position:absolute;bottom:12px;z-index:100;padding:5px;display:none;background-color: #FAFEFF !important;box-shadow: -2px 2px 2px #333;}' +
        ...
        return this.each(function () {
            ...
            options.detailsHTML = $('#'+$(this).attr('data-slug')).html();
